	...
	<div class="Content">
		<div class="frm">
			<div class="frmContent" style="background-color: white;">
				<div class="frmTitle" >
					<h2>Subir Direccion</h2>
				</div>
				<!--Upload files to server-->
				<div class="frmFields" >
					<form id="uploadForm" action="uploaddireccion.php" method="post">
					<div>
					...
					<!---->
					<form id="uploadForm" action="processdireccion.php" method="post">
						...
						<input type="submit" id="truncar" name="action"  value="Preparar" class="btnPrepara" /></p>
					</form>
					</div>
				</div>
			</div>
